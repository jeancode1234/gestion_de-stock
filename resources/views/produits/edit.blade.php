              ...
              <div class="col-md-8">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form action="{{route('produits.update',$produit->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="form-group ">
                            ...
                            <select name="id_cat" id="" class="form-control">
                              ...
                              <option <?=$cat->id == $produit->id_cat ? 'selected':'' ?> value="{{$cat->id}}">{{$cat->nom}}</option>
                              @endforeach
                          ...
                          <div class="form-group">
                            ...
                            <input type="number" value="{{$produit->quantite}}" name="quantite" class="form-control">
                          </div>
                        
                          <div class="form-group">
                            <label class="bmd-label-floating">Prix du produit</label>
                            <input type="number" value="{{$produit->prix}}" name="prix" class="form-control">
                          </div>
                      ...
                      <button type="submit" name="submit" class="btn btn-rose pull-right">Modifier le produit</button>
               ...
               <div class="col-md-4">
                <div class="card card-profile">
                  ...
                  <div class="card-body">
                    <h6 class="card-category text-gray">{{$produit->nom}}</h6>
