                      ...
                      <div class="row">
                        <div class="col-md-10">
                            <div class="card-icon">
                              ...
                              <h4 class="card-title">Total de mes commandes: <strong>{{$total}} articles</strong> </h4>
                        </div>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="td-actions text-right d-flex align-item-center justify-content-end">
                                <form action="{{route('vente.commande',$commande->id)}}" method="post" >
                                  @csrf
                                  <button type="submit" class="btn btn-success btn-round" rel="tooltip" >
                                    <i class="material-icons">money</i>
                                  </button>
                                </form>
    
                                <a href="{{route('produits.show',$commande->id)}}" rel="tooltip" class="btn btn-info btn-round mx-1">
                                    <i class="material-icons">person</i>
                                </a>
